...
bool RTIMUGD20HM303D::setGyroCTRL2()
{
    ...
    return I2CWrite(m_gyroSlaveAddr,  L3GD20H_CTRL2, m_settings->m_GD20HM303DGyroHpf, "Failed to set L3GD20 CTRL2");
}
...
bool RTIMUGD20HM303D::setGyroCTRL5()
{
    ...
    return I2CWrite(m_gyroSlaveAddr,  L3GD20H_CTRL5, ctrl5, "Failed to set L3GD20 CTRL5");
}
